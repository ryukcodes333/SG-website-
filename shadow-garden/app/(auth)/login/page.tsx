...
import { Phone, ArrowRight, Leaf, RotateCcw, CheckCircle } from "lucide-react";
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="card-base p-6 space-y-5">
                ...
                {devOtp && (
                  <div className="mt-2 p-2 bg-[#1a3324] rounded-lg">
                    <p className="text-xs text-[#6ea882]">
                      Dev mode OTP: <strong className="text-white">{devOtp}</strong>
                    </p>
                  </div>
                )}
              </div>
          ...
          <p className="text-center text-xs text-[#9ca3af]">
            No account?{" "}
            <Link href="/register" className="text-[#4a8c5c] hover:text-[#6ea882] transition-colors">
              Register here
            </Link>
          </p>
        </div>
